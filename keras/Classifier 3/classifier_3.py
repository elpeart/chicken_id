# -*- coding: utf-8 -*-
"""
Created on Mon Apr 27 19:57:45 2020
...
# Fit the data
history = model.fit(x, y, validation_split = 0.33, epochs = 50, batch_size = 10, callbacks = [checkpoint])

# model.save('ChickenID_3.h5')  # Save the model for latger use